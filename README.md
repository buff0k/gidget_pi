...
All I2C devices share the Pi I2C bus:

| Pi physical pin | Pi GPIO | Use |
|---:|---:|---|
| Pin 1 | 3V3 | Sensor/OLED VCC where 3.3V is supported |
| Pin 3 | GPIO2 / SDA1 | I2C SDA |
| Pin 5 | GPIO3 / SCL1 | I2C SCL |
| Pin 6 | GND | Ground |
...
| Module pin | Pi physical pin | Notes |
|---|---:|---|
| VIN / VCC | Pin 1 | 3.3V |
| GND | Pin 6 | Ground |
| SDA | Pin 3 | I2C SDA |
...
Leave these disconnected for the current single-sensor setup:
...
| BMI160 pin | Pi physical pin | Notes |
|---|---:|---|
| VIN | Pin 1 | 3.3V preferred |
| GND | Pin 6 | Ground |
| SDA | Pin 3 | I2C SDA |
| SCL | Pin 5 | I2C SCL |
| SAO / SA0 | GND or 3.3V | Address select: usually `0x68` or `0x69` |
